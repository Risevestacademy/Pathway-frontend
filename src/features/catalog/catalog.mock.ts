import type { Career } from './catalog.types'
...
export const careers: Career[] = [
  {
    ...
    stats: [
      { kind: 'salary-median', id: 's1', value: 92750, currency: 'USD', payPeriod: 'year', basis: 'gross', source: 'U.S. Bureau of Labor Statistics', period: 'May 2024', geography: 'United States', meaning: 'Median annual salary, all experience levels' },
      { kind: 'salary-range', id: 's2', currency: 'USD', payPeriod: 'year', basis: 'gross', low: { label: '25th percentile', value: 68400 }, high: { label: '75th percentile', value: 124100 }, source: 'U.S. Bureau of Labor Statistics', period: 'May 2024', geography: 'United States', meaning: 'Middle 50% of annual salaries' },
      { kind: 'salary-median', id: 's3', value: 450000, currency: 'NGN', payPeriod: 'month', basis: 'unspecified', experienceLevel: 'entry-level', source: 'Rise Academy Salary Survey', period: 'Q2 2025', geography: 'Lagos, Nigeria', meaning: 'Median monthly salary, entry-level roles' },
      { kind: 'employment-projection', id: 'o1', value: 8, series: [{ label: '2023', value: 208 }, { label: '2033 (projected)', value: 225 }], seriesUnit: 'jobs (thousands)', source: 'U.S. Bureau of Labor Statistics', period: '2023\u20132033', geography: 'United States', meaning: 'Projected 10-year employment growth' },
      { kind: 'demand', id: 'o2', value: 'High', source: 'LinkedIn Economic Graph', period: 'Jan 2025', geography: 'Lagos, Nigeria', meaning: 'Current hiring demand' },
    ],
  },
  {
    id: 'data-analyst',
    ...
    stats: [
      { kind: 'salary-median', id: 's1', value: null, currency: 'USD', payPeriod: 'year', basis: 'gross', source: 'U.S. Bureau of Labor Statistics', period: 'May 2024', geography: 'United States', meaning: 'Median annual salary, all experience levels' },
      { kind: 'salary-range', id: 's2', currency: 'NGN', payPeriod: 'month', basis: 'unspecified', low: { label: '25th percentile', value: 280000 }, high: { label: '75th percentile', value: null }, source: 'Rise Academy Salary Survey', period: 'Q2 2025', geography: 'Lagos, Nigeria', meaning: 'Middle 50% of monthly salaries' },
      { kind: 'employment-projection', id: 'o1', value: null, source: 'U.S. Bureau of Labor Statistics', period: '2023\u20132033', geography: 'United States', meaning: 'Projected 10-year employment growth' },
      { kind: 'demand', id: 'o2', value: 'Very high', source: 'LinkedIn Economic Graph', period: 'Jan 2025', geography: 'Lagos, Nigeria', meaning: 'Current hiring demand' },
    ],
  },
  {
    id: 'ux-researcher',
    ...
    roadmapId: null,
    stats: [
      { kind: 'salary-median', id: 's1', value: 101200, currency: 'USD', payPeriod: 'year', basis: 'gross', source: 'Glassdoor', period: 'Mar 2025', geography: 'United States', meaning: 'Median annual base salary, all experience levels' },
      { kind: 'demand', id: 'o1', value: 'Moderate', source: 'LinkedIn Economic Graph', period: 'Jan 2025', geography: 'United States', meaning: 'Current hiring demand' },
    ],
  },
  {
    id: 'product-manager',
